...
*******************************************************************************/
static inline uint16_t MC_ATTRB_INLINE MC_TransformClarkeInverseSwappedInput_InlineC(MC_ALPHABETA_T *pAlphaBeta,
                                                                              MC_ABC_T *pABC);
...
/*******************************************************************************
  ...
  Remarks:
    This routine requires inputs in the 1.15 format.
*******************************************************************************/
static inline uint16_t MC_ATTRB_INLINE MC_CalculateSpaceVectorPhaseShifted_InlineC(MC_ABC_T *pABC,
                                                                            uint16_t iPwmPeriod,
...
/*******************************************************************************
  ...
  Remarks:
    This routine requires inputs in the 1.15 format.
*******************************************************************************/
static inline uint16_t MC_ATTRB_INLINE MC_TransformClarke_InlineC(MC_ABC_T *pABC,
...
/*******************************************************************************
  ...
  Remarks:
    This routine requires inputs in the 1.15 format.
*******************************************************************************/
static inline uint16_t MC_ATTRB_INLINE MC_TransformPark_InlineC(MC_ALPHABETA_T *pAlphaBeta,
                                                         MC_SINCOS_T *pSinCos,
                                                         MC_DQ_T *pDQ);
